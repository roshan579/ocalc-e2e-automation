package com.calc.test.framework.report;

import com.calc.test.framework.model.ReportModel;
...
public class ConsolidatedReport {
    ...
    public void copyJsonFilesFromJobs() {
        ...
        File destDir = new File(MergeReports.FILE_PATH);
        if (!destDir.exists()) {
            destDir.mkdirs();
        }
    ...
    public void getStatisticsFromJsons() throws Exception {
        List<String> jsonFileList = mergeReports.getJsonFiles(MergeReports.FILE_PATH);
